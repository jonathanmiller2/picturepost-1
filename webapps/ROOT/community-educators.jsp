...
<div align=center>
  <h1 style='display:inline-block;'>Challenges, Investigations, and Field Studies</h1>
</div>
...
<div class="container" id=helppagecontent>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <h3>DEW Resources</h3>
      <p class=clearfix>
      <img class='shadow pull-left' src="images/dew.logo.png"  width="300" style='margin:0 16px 16px 0;' alt="DEW logo">
       <ul>
        <li><a href="http://dew.globalsystemsscience.org" target="_blank" title="ALl About DEW e-book">E-Book All About DEW</a>
        <li><A href=" http://dew.globalsystemsscience.org/activities/challenges" target="_blank" title="DEW Challenges">Challenges - short classroom experiments that can be finished within an class period or less. </a></li>
       <li><A href=" http://dew.globalsystemsscience.org/activities/investigations" target="_blank" title="DEW Investigations">Investigations - lengthier experiments that require more involvement and may take several classroom sessions to complete.</a></li>
        </ul>
     </div>
    ...
    <div class="col-md-4">
      ...
      <p class=clearfix>
       <img class='shadow pull-left' src="/images/logoglobecarbon.png"   style='margin:0 16px 16px 0;' alt="GLOBE Carbon Cycle logo"></A>
<div>Brings the most cutting edge research and research techniques in the field of terrestrial ecosystem carbon cycling into the classroom. Students can collect data about their school field site through existing GLOBE protocols of phenology, land cover and soils as well as through new protocols focused on biomass and carbon stocks in vegetation. Study plots are perfect for monitoring with a Picture Post! </div>    
     ...
     <div class="col-md-4">
      ...
      <p class=clearfix>
       <img class='shadow pull-left' src="/images/logoNASANICE.png"  style='margin:0 16px 16px 0;' alt="NASA Nice Project logo"></A></BR>
<div>Students can become familiar with Earth observation data and the science of climate change by conducting their own research investigations using NASA Earth observation data and based on their own questions and/or self-designed procedures. Activities include using picture posts! SCD is a project of NASA Innovations in Climate Education (NASA NICE). </div>    
   ...
   <div class="row">
    <div class="col-md-4">
      ...
      <p class=clearfix>
      <img class='shadow pull-left' src=" /images/CSA-NEON-logo.png" style='margin:0 16px 16px 0;' alt="Case Study for NEON CSA521">
...
<div>Learn more about this project, funded by the National Science Foundation, that works with middle and high school teachers to use mobile technologies in their outdoor classrooms.
   ...
   <div class="col-md-4">
      <h3>Forest Watch</h3>
      <p class=clearfix>
      <img class='shadow pull-left' src="/images/logoforestwatch.png"  width="300" style='margin:0 16px 16px 0;' alt="Forest Watch Banner">
<div>Learn more about this project, funded by the National Science Foundation, that works with middle and high school teachers to use mobile technologies in their outdoor classrooms.</div>   
        <p class=clearfix><a class="btn btn-default" href="http://www.forestwatch.sr.unh.edu/index.shtml" title="Forest Watch website"  target="_blank" role="button">Take Me There</a></p>
     </div>
</div>
