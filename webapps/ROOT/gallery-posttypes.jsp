...
<div class="container" id=helppagecontent>
 ...
 <img src="/images/signs-composite.jpg" width="205" height="174" alt="signs composite picture">
   ...
   <div class="col-md-4">
      <h3><a href="http://picturepost.ou.edu/post.jsp?postId=554"  name="Phenology Phencepost ">Phenology Phencepost Kansas City MO</a></h3> 
  ...
  <div class="col-md-4">
       <h3><a href="http://picturepost.ou.edu/post.jsp?postId=269"  name="Lake Merced">Lake Merced</a></h3>
  ...
  <div class="row">
    <div class="col-md-4">
    <h3><a href="https://picturepost.ou.edu/post.jsp?postId=1310"  name="The Nature Conservancy Post Top">Manchester Cedar Swamp</a></h3>
 <img src="/images/post-TNCtop_bot.png" width="205" height="174" alt="modified post top with start and stop lines">
   ...
   <div class="col-md-4">                   
     <h3><a href="http://picturepost.ou.edu/post.jsp?postId=17"  name="Mackworth Island ">Mackworth Island Falmouth, ME</a></h3> 
     <img src="/images/post-plasticall.png" width="205" height="174" alt="picture post built from plastic lumber">

      <P>This post was made from all recycled plastic lumber. It was installed by Jeff Beaudry on Mackworth Island in Falmouth, ME.</P>
</div> 

     <div class="col-md-4">
        <h3><a href="http://picturepost.ou.edu/post.jsp?postId=138"  name="Devil's Backbone1">Devil's Backbone 1</a></h3>
 <img src="/images/post-paulmobile.png" width="205" height="174" alt="portable picture post">
   ...
   <li><a href="http://picturepost.ou.edu/post.jsp?postId=139"  name="Devil's Backbone2">Devil's Backbone 2</a>
...
<a class="btn btn-default" href="/build_mobile1.jsp" name ="instructions for building a mobile post" role="button">Instructions</a>
  ...
  <div class="row">
    <div class="col-md-4">
   <h3><a href="http://picturepost.ou.edu/post.jsp?postId=5"  name="Menotomy Rocks Post 1">Menotomy Rocks Post 1</a></h3>
 <img src="/images/post-orig.png" width="205" height="174" alt="original post design">
    ...
    <div class="col-md-4">
      <h3> <a href="http://picturepost.ou.edu/post.jsp?postId=1"  name="Seacoast Science Center">Seacoast Science Center</a></h3>
      <img src="/images/post-ssctop.png" width="205" height="174" alt="post top on existing sign at Seacoast Science Center">
                  <P>This is a plastic lumber post top attached to an existing sign at the Seacoast Science Center in Rye, NH. The site is an archeological site from WWII and no holes can be dug! </P>
 </div>
                  
   <div class="col-md-4">
        <h3><a href="http://picturepost.ou.edu/post.jsp?postId=135" name="Annettes Yard Test Post">Annette's Yard Test Post</a></h3>
<img src="/images/post-decktop.png" width="205" height="174" alt="plastic post top on deck">
         <P>This is a plastic lumber post top placed by Annette Schloss on the corner of her backyard deck. The top was not attached but brought inside in between picture takings. Sadly, after a year of pictures, the deck was replaced with a room addition to the house. A new post was added!
         <li><a href="http://picturepost.ou.edu/post.jsp?postId=428" name="Annettes Yard Post 2">Annette's Yard Post 2</a></P>
