...
<div class="container" id=helppagecontent>
  ...
  <div class="row">
    <div class="col-md-4">
       <H3>Materials (Cost ~ $20-$30)</H3>
           <UL>
                          <LI>7 to 8 foot 4&quot; x 4&quot; post (consider pressure-treated lumber or plastic composite lumber)
                            <LI>9-inch diameter plywood disc, 3/4&quot; thick
                         <LI> 5-inch plywood octagon (2-inch sides) 3/8&quot; to 1/2&quot; thick
                          <LI>Permanent marker or paint with fine tipped brush
   ...
   <div class="col-md-4">
       <H3>Equipment</H3>
       <img class='shadow pull-left' src="images/post-installTools.jpg" width="288" height="187"  style='margin:0 16px 16px 0;' alt="tools">      
       <p class=clearfix>
       <UL>
                        <LI>Portable drill and 1/8&quot; drill bit
                             <LI>Saw 
                             <LI>Shovel or post-hole digger
                             <LI>Compass
                             <LI>GPS (Global Positioning Satellite device)
        </UL>
     </p> 
 </div>
   <div class="col-md-4">
   ...
   <p class=clearfix></p><UL>
                        <LI>Cut 9-inch disc (or cut a 9-inch octagon-see example on right)
  ...
  <div class="row">
   ...
   <H3>Step 4: Assembling the Post</H3>
    <UL>
                        <LI>Center and level post head (from Step 1) onto post.
                        <LI>Take and record the GPS reading from the top of the post to find the latitude and longitude.
    </ul>
</div>
